...
from spectre_api_client import rest
from spectre_api_client.configuration import Configuration
from spectre_api_client.exceptions import ApiTypeError, ApiValueError, ApiException
from spectre_api_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.add_command  # this is an instance of the class Endpoint
        api_instance.add_command()  # this invokes api_instance.add_command.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_command.callable or self.callable in this class
